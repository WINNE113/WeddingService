...
public interface WishListRepository extends JpaRepository<WishlistEntity, Long> {
    ...
    @Query(value = "Select s.id, s.min_price as minPrice, s.max_price as maxPrice, s.title, s.address, s.created_date as createdDate, s.image, wi.wishlist_item_id as wishListItemId\n" +
            "from services as s\n" +
            ...
            "group by s.id, s.title, s.min_price, s.max_price, s.address, s.created_date, s.image, wi.wishlist_item_id \n" +
