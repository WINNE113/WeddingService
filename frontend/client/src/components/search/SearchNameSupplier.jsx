        ...
        <div className="mt-4">
          ...
          <div className="mt-3 grid grid-cols-4 gap-3">
            {suppliers.map((option) => (
              <span
                key={option.id}
                className={`col-span-1 cursor-pointer p-2 flex items-center justify-center rounded-md bg-gray-100 hover:border-emerald-600 ${selectedOption === option.value ? "border-emerald-600" : ""
                  }`}
